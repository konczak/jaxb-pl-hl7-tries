...
public class Try02Test {
    ...
    public void shouldReturnStringWithXmlSameAsInputFileMinified() throws Exception {
        // given
        final String filePath = Constants.PROJECT_RESOURCES_PATH + "t02\\2.16.840.1.113883.3.4424.13.10.1.26-1-minified.xml";
        ...
        // then
        String expectedContent = Files.readString(Paths.get(Constants.PROJECT_RESOURCES_PATH + "t02\\expected-minified.xml"))
                .replace("\r\n", "\n");
