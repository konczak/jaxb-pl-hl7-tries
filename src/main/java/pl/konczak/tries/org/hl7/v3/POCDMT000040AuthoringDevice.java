...
public class POCDMT000040AuthoringDevice {
    ...
    @XmlElement(name = "asMaintainedEntity")
    protected List<POCDMT000040MaintainedEntity> asMaintainedEntities;
    ...
    /**
     * Gets the value of the asMaintainedEntities property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the asMaintainedEntities property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAsMaintainedEntities().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<POCDMT000040MaintainedEntity> getAsMaintainedEntities() {
        if (asMaintainedEntities == null) {
            asMaintainedEntities = new ArrayList<POCDMT000040MaintainedEntity>();
        }
