...
public class POCDMT000040EncompassingEncounter {
    ...
    @XmlElement(name = "encounterParticipant")
    protected List<POCDMT000040EncounterParticipant> encounterParticipants;
    ...
    /**
     * Gets the value of the encounterParticipants property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the encounterParticipants property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEncounterParticipants().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<POCDMT000040EncounterParticipant> getEncounterParticipants() {
        if (encounterParticipants == null) {
            encounterParticipants = new ArrayList<POCDMT000040EncounterParticipant>();
        }
