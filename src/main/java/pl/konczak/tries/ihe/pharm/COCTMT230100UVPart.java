 ...
 *       &lt;attribute name="classCode" use="required" type="{urn:ihe:pharm}RoleClassPart" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class COCTMT230100UVPart {
    ...
    @XmlElement(name = "subjectOf", nillable = true)
    protected List<COCTMT230100UVSubject4> subjectOves;
    ...
    /**
     * Gets the value of the subjectOves property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the subjectOves property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSubjectOves().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<COCTMT230100UVSubject4> getSubjectOves() {
        if (subjectOves == null) {
            subjectOves = new ArrayList<COCTMT230100UVSubject4>();
        }
        return this.subjectOves;
    }
