 ...
 *         &lt;element name="code" type="{urn:ihe:pharm}CD"/&gt;
 *         &lt;element name="name" type="{urn:ihe:pharm}TN" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="nullFlavor" type="{urn:ihe:pharm}NullFlavor" /&gt;
 *       &lt;attribute name="classCode" use="required" type="{urn:ihe:pharm}EntityClassState" /&gt;
