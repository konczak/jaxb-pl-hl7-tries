 ...
 * &lt;complexType name="ED"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{urn:ihe:pharm}BIN"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="reference" type="{urn:ihe:pharm}TEL" minOccurs="0"/&gt;
 *         &lt;element name="thumbnail" type="{urn:ihe:pharm}thumbnail" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="mediaType" type="{urn:ihe:pharm}cs" default="text/plain" /&gt;
 *       &lt;attribute name="language" type="{urn:ihe:pharm}cs" /&gt;
 *       &lt;attribute name="compression" type="{urn:ihe:pharm}CompressionAlgorithm" /&gt;
 *       &lt;attribute name="integrityCheck" type="{urn:ihe:pharm}bin" /&gt;
 *       &lt;attribute name="integrityCheckAlgorithm" type="{urn:ihe:pharm}IntegrityCheckAlgorithm" default="SHA-1" /&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
    ...
    extends BIN
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "reference", namespace = "urn:ihe:pharm", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "thumbnail", namespace = "urn:ihe:pharm", type = JAXBElement.class, required = false)
    })
    @XmlMixed
